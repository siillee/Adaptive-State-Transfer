...
sudo tc class add dev $INTERFACE parent 1:1 classid 1:10 htb rate 412mbit ceil 700mbit
sudo tc class add dev $INTERFACE parent 1:1 classid 1:20 htb rate 588mbit ceil 1gbit
